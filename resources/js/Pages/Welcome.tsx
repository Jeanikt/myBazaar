            ...
            <div className="min-h-screen bg-[#0A0A0A] text-white">
                ...
                <main className="relative flex flex-col items-center justify-center flex-1 text-center p-6 md:px-12">
                    ...
                    <p className="relative font-ui-sans-serif font-normal text-[20px] leading-[30px] text-[#fafafacc] mb-8 md:text-xl z-10">
                        Discover a vibrant marketplace where you can buy and
                        sell unique bazaar treasures!
                        <br /> Whether you're looking for vintage clothing,
                        handmade crafts, or rare collectibles,
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <Card className="bg-[#0A0A0A] text-white border-none">
                            ...
                            <CardContent className="text-start">
                                <p>
                                    Consolidate notifications from various
                                    sources into one intuitive dashboard for
                        ...
                        <Card className="bg-[#0A0A0A] text-white border-none">
                            ...
                            <CardContent className="text-start">
                                <p>
                                    Connect MyBazar with your existing tools
                                    using webhooks for a smooth, automated
                        ...
                        <Card className="bg-[#0A0A0A] text-white border-none">
                            ...
                            <CardContent className="text-start">
                                <p>
                                    Leverage the power of analytics to make
                                    informed decisions and improve your team's
                        ...
                        <Card className="bg-[#0A0A0A] text-white border-none">
                            ...
                            <CardContent className="text-start">
                                <p>
                                    Enjoy a streamlined developer experience
                                    with our easy-to-use API, designed for quick
                        ...
                        <Card className="bg-[#0A0A0A] text-white border-none">
                            ...
                            <CardContent className="text-start">
                                <p>
                                    ...
                                    Discord, Slack, and more, with MyBazar.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-[#0A0A0A] text-white border-none">
                            ...
                            <CardContent className="text-start">
                                <p>
                                    ...
                                    properties, ensuring a rich context for
                                    every notification sent through MyBazar.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
